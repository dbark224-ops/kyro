...
export const assistantToolRegistry: AssistantToolRegistryItem[] = [
  ...
  },
  {
    ...
    label: "SMS outbound",
    notes:
      "Twilio-backed SMS delivery through Kyro's durable outbox, consent guard, audit trail, retries, and usage metering. Direct workplace-contact sends require an explicit user instruction.",
    permission: "Send SMS through the workspace Kyro number",
    provider: "Twilio",
    risk: "high",
    status: "active",
    surfaces: ["Inbox", "Assistant", "Notifications", "Voice"],
    uiBlocks: ["approval_queue", "activity_preview"],
  },
  {
    approval: "workspace_policy",
    category: "external",
    ...
    label: "Phone call",
    notes:
      "Vapi-backed outbound customer calls. Text Assistant prepares a user-click review card; trusted internal Vapi voice and internal SMS instructions can start calls directly after contact/phone/instruction resolution. External customer call contexts are blocked from starting arbitrary outbound calls.",
    permission: "Start or log a phone call through a connected phone provider",
    provider: "Vapi + Twilio",
    risk: "high",
    status: "active",
    surfaces: ["Assistant", "Vapi Voice", "Internal SMS", "Phone activity"],
